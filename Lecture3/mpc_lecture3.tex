...
\begin{document}
    ...
    \begin{frame}{HJB方程式}
        ...
        \begin{tikzpicture}
            ...
            \fill[white] (0.5, -2) circle (0.1) node[right, black]{\colorbox{yellow}{$V(x, t) = \min_{u[t, t+dt]} \left( L(x, u, t) dt + V \left(x, t\right) + \frac{\partial V}{\partial x}\left(x, t\right)f\left(x, u, t\right)dt + \frac{\partial V}{\partial t}\left(x, t\right)dt \right)$}};
            \fill[white] (0.5, -3) circle (0.1) node[right, black]{\colorbox{yellow}{$0 = \min_{u[t, t+dt]} \left( L(x, u, t) + \frac{\partial V}{\partial x}\left(x, t\right)f\left(x, u, t\right) + \frac{\partial V}{\partial t}\left(x, t\right) \right) dt$}};
